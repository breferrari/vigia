...
> hundred undrawn files rewritten at once: **13.07ms p50, 14.31ms p99** against
> 16ms, so it holds without much room: the worst single frame in that run was
> 16.29ms, which is over, and I9 is a p99 rather than a maximum for the reason §7
> gives about cold samples. An agent running a
