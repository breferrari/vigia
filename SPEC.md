...
**The mode word, and the set it implies.** It sits on the right, alone. The mockup draws it there with the count beside it, and that half of the picture is not kept, for the reason two paragraphs up.
