...
**Three of these five are claims problems, and they are ordered ahead of the shipping work for one reason.** [#66](https://github.com/breferrari/vigia/issues/66) and [#67](https://github.com/breferrari/vigia/issues/67) are places the picture says something the binary does not do; [#47](https://github.com/breferrari/vigia/issues/47) is a place the **spec** does, since I3's budget names a day and the longest window ever run is an hour. All three are survivable while the only reader is the author and become support burden the moment [#12](https://github.com/breferrari/vigia/issues/12) hands them an audience. [#12](https://github.com/breferrari/vigia/issues/12) is therefore last of the four, not first.

[#72](https://github.com/breferrari/vigia/issues/72) is the odd one and it is here rather than on the shelf because [#50](https://github.com/breferrari/vigia/issues/50) cannot be answered without it: §10 says *"confirm against a week of real use"* and no issue tracked the use, so #50 has sat in this phase permanently unresolvable. It is also the only thing that converts four shelf entries from judgement into evidence — see the shelf note under [#19](https://github.com/breferrari/vigia/issues/19), which is the second time a deferral reason turned out to be a dated claim nobody re-checked.
