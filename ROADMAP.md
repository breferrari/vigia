...
| ⬜ | Text cannot be selected or copied. The terminal's own modifier is documented and `y` copies the caret path (B9), but in-app selection is unbuilt and the ruling against it is withdrawn. **Reported from use** | [#177](https://github.com/breferrari/vigia/issues/177) |
